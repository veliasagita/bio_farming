...
import 'dart:io';
// import 'package:flutter/assets.dart';
import 'package:cached_network_image/cached_network_image.dart';

class RecipeDetailsPage extends StatelessWidget {
  static final String path = "lib/views/recipe_details.dart";
  @override
  ...
  Widget _buildStep({String? leadingTitle, required String title, String? content}) {
    return Row(
      ...
      children: <Widget>[
        Material(
          ...
          child: Container(
            ...
            child: Text(leadingTitle!, style: const TextStyle(
              color: Colors.white,
